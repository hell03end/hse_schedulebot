...
MESSAGES = {
    ...
    'service:common_handlers': {
        ...
        'on_stop:complete': f"До свидания {emojize(':waving_hand:')}",
        'on_stop:unregistered': f"Привет! У меня можно подсмотреть "
            f"расписание пар (в том числе преподавателям) "
    ...
    'service:settings': {
        ...
        'show_about': "Я умею показывать расписание занятий как для "
            "студентов, так и для преподавателей. В будущем я научусь и "
            "другим полезным функциям.\n\nПри показе расписания на неделю: "
            "Если сегодня среда, то Пн и Вт на клавиатуре - "
            "<b>будущая неделя</b>."
    },
    'schedule:day': {
    ...
    'schedule:start': {
        ...
        'on_schedule:unregistered': "Сначала надо зарегистрироваться!",
        'on_back:msg': "Вот предыдущее меню",
